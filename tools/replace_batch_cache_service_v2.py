...
SERVICE = r'''package com.jianglab.babywife;
...
LOCK = r'''package com.jianglab.babywife;
...
def main():
    ...
    package = root / 'app/src/main/java/com/jianglab/babywife'
    (package / 'PlaylistBatchCacheService.java').write_text(SERVICE, encoding='utf-8')
    (package / 'CacheKeyLock.java').write_text(LOCK, encoding='utf-8')
    print('isolated_batch_service_v2=written')
